...
<html>
    <head>
        ...
        <title>CRUD Eloquent Laravel - Edit Data</title>
    </head>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">CRUD Data Pegawai – <strong>EDIT DATA</strong></h3>
                                        <div class="card-tools">
                                            <a href="/pegawai2" class="btn btn-primary">Kembali</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <form method="post" action="/pegawai2/update/{{ $pegawai->id }}">
                                            {{ csrf_field() }}
                                            {{ method_field('PUT') }}
